...
func newMovie(db *gorm.DB, opts ...gen.DOOption) movie {
	...
	_movie.MovieID = field.NewString(tableName, "movie_id")
	_movie.Name = field.NewString(tableName, "name")
	_movie.Director = field.NewString(tableName, "director")
	_movie.Summary = field.NewString(tableName, "summary")
	_movie.ThumbnailPath = field.NewString(tableName, "thumbnail_path")
	_movie.Link = field.NewString(tableName, "link")
...
func (m *movie) updateTableName(table string) *movie {
	...
	m.ThumbnailPath = field.NewString(table, "thumbnail_path")
...
func (m *movie) fillFieldMap() {
	...
	m.fieldMap["thumbnail_path"] = m.ThumbnailPath
