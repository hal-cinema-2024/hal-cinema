  ...
  return {
    movies: {
      _movieId: (val1: string) => {
        ...
        return {
          ...
          put: (option: { body: Methods_y9smcz['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_y9smcz['put']['resBody'], BasicHeaders, Methods_y9smcz['put']['status']>(prefix, prefix1, PUT, option, 'FormData').json(),
          /**
           * Update movie
           * @returns A successful response.
           */
          $put: (option: { body: Methods_y9smcz['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_y9smcz['put']['resBody'], BasicHeaders, Methods_y9smcz['put']['status']>(prefix, prefix1, PUT, option, 'FormData').json().then(r => r.body),
          $path: () => `${prefix}${prefix1}`,
        };
      },
      /**
      ...
      get: (option?: { query?: Methods_88yz43['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_88yz43['get']['resBody'], BasicHeaders, Methods_88yz43['get']['status']>(prefix, PATH0, GET, option).json(),
      /**
       * Get all movies
       * @returns A successful response.
       */
      $get: (option?: { query?: Methods_88yz43['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_88yz43['get']['resBody'], BasicHeaders, Methods_88yz43['get']['status']>(prefix, PATH0, GET, option).json().then(r => r.body),
      /**
       * Create movie
       * @returns A successful response.
       */
      post: (option: { body: Methods_88yz43['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_88yz43['post']['resBody'], BasicHeaders, Methods_88yz43['post']['status']>(prefix, PATH0, POST, option, 'FormData').json(),
      /**
       * Create movie
       * @returns A successful response.
       */
      $post: (option: { body: Methods_88yz43['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_88yz43['post']['resBody'], BasicHeaders, Methods_88yz43['post']['status']>(prefix, PATH0, POST, option, 'FormData').json().then(r => r.body),
    ...
    orders: {
      ...
      get: (option?: { query?: Methods_c8s91v['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_c8s91v['get']['resBody'], BasicHeaders, Methods_c8s91v['get']['status']>(prefix, PATH1, GET, option).json(),
      /**
       * Get all orders
       * @returns A successful response.
       */
      $get: (option?: { query?: Methods_c8s91v['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_c8s91v['get']['resBody'], BasicHeaders, Methods_c8s91v['get']['status']>(prefix, PATH1, GET, option).json().then(r => r.body),
      /**
       * Create order
       * @returns A successful response.
       */
      post: (option: { body: Methods_c8s91v['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_c8s91v['post']['resBody'], BasicHeaders, Methods_c8s91v['post']['status']>(prefix, PATH1, POST, option).json(),
      /**
       * Create order
       * @returns A successful response.
       */
      $post: (option: { body: Methods_c8s91v['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_c8s91v['post']['resBody'], BasicHeaders, Methods_c8s91v['post']['status']>(prefix, PATH1, POST, option).json().then(r => r.body),
    ...
    reservations: {
      ...
      post: (option: { body: Methods_arxoa5['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_arxoa5['post']['resBody'], BasicHeaders, Methods_arxoa5['post']['status']>(prefix, PATH2, POST, option).json(),
      /**
       * Create reservation
       * @returns A successful response.
       */
      $post: (option: { body: Methods_arxoa5['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_arxoa5['post']['resBody'], BasicHeaders, Methods_arxoa5['post']['status']>(prefix, PATH2, POST, option).json().then(r => r.body),
      $path: () => `${prefix}${PATH2}`,
    },
    schedules: {
      ...
      get: (option?: { query?: Methods_lxn7j8['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_lxn7j8['get']['resBody'], BasicHeaders, Methods_lxn7j8['get']['status']>(prefix, PATH3, GET, option).json(),
      /**
       * Get all schedules
       * @returns A successful response.
       */
      $get: (option?: { query?: Methods_lxn7j8['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_lxn7j8['get']['resBody'], BasicHeaders, Methods_lxn7j8['get']['status']>(prefix, PATH3, GET, option).json().then(r => r.body),
      /**
       * Create schedule
       * @returns A successful response.
       */
      post: (option: { body: Methods_lxn7j8['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_lxn7j8['post']['resBody'], BasicHeaders, Methods_lxn7j8['post']['status']>(prefix, PATH3, POST, option).json(),
      /**
       * Create schedule
       * @returns A successful response.
       */
      $post: (option: { body: Methods_lxn7j8['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_lxn7j8['post']['resBody'], BasicHeaders, Methods_lxn7j8['post']['status']>(prefix, PATH3, POST, option).json().then(r => r.body),
